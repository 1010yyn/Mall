...
public class Shop_Order_Handle extends AppCompatActivity {

    private String TAG = "MYTAG";
    private int GET_ORDER_OK = 1;
    private int GET_USER_OK = 2;
    private int UPDATE_ORDER_OK = 3;
    ...
    private Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            } else if (msg.what == UPDATE_ORDER_OK) {
                finish();
            }
        }
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.layout_shop__order__handle);
        intent = getIntent();
    ...
    void setData() {
        ...
        Button pay = findViewById(R.id.shop_order_send);
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    if (rst.equals("true"))
                        handler.sendEmptyMessage(UPDATE_ORDER_OK);
                } catch (JSONException e) {
                    e.printStackTrace();
                }
            }
